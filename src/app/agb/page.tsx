    ...
    <main className="min-h-screen bg-slate-950 px-6 py-16 text-white">
      <section className="mx-auto max-w-4xl">
        ...
        <div className="mt-10 space-y-8 rounded-3xl border border-white/10 bg-white/5 p-8">
          <section>
            <h2 className="text-2xl font-bold">1. Anbieter</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold">2. Geltungsbereich</h2>
          ...
          <section>
            ...
            <p className="mt-4 text-slate-300">
              ...
              suchen und Anfragen senden.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-bold">4. Firmenprofile</h2>
          ...
          <section>
            ...
            <p className="mt-4 text-slate-300">
              ...
              Abschlüssen wird nicht garantiert.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-bold">6. Werbung und Angebote</h2>

            <p className="mt-4 text-slate-300">
              Werbeanzeigen und Angebote müssen wahrheitsgemäss, aktuell und
              rechtlich zulässig sein. Die jeweilige Firma ist für Inhalt,
              Preisangaben, Verfügbarkeit, Leistungserbringung und rechtliche
              Zulässigkeit ihrer Werbung verantwortlich.
            </p>
          </section>
          ...
          <section>
            <h2 className="text-2xl font-bold">8. Pflichten der Firmen</h2>

            <p className="mt-4 text-slate-300">
              Firmen verpflichten sich, erhaltene Anfragen sorgfältig zu
              bearbeiten, keine missbräuchlichen Inhalte zu veröffentlichen,
              keine Rechte Dritter zu verletzen und keine falschen oder
              irreführenden Angaben zu machen. Zugangsdaten und Partner-Links
              sind vertraulich zu behandeln.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-bold">9. Preise und Zahlung</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold">10. Laufzeit und Kündigung</h2>

            <p className="mt-4 text-slate-300">
              Laufzeit und Kündigungsfristen richten sich nach der jeweiligen
              Vereinbarung mit der Firma. Ohne besondere Vereinbarung kann ein
              Paket jeweils auf Ende der laufenden Abrechnungsperiode gekündigt
              werden. Bereits bezahlte Beträge werden grundsätzlich nicht
              zurückerstattet, sofern keine zwingenden gesetzlichen Ansprüche
              bestehen.
            </p>
          </section>
          ...
          <section>
            <h2 className="text-2xl font-bold">13. Datenschutz</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold">16. Stand</h2>
